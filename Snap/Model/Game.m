...
{
    self.isSingleGame = YES;
    
    self.isServer = YES;
    
    Player *player = [[Player alloc] init];
    player.name = NSLocalizedString(@"主人", @"Single player mode, name of user (bottom player)");
    player.peerID = @"1";
    player.position = PlayerPositionBottom;
    [_players setObject:player forKey:player.peerID];
...
- (void)showAlert
{
    UIAlertView *alertView = [[UIAlertView alloc]
                              initWithTitle:NSLocalizedString(@"卡牌数量不对", @"Cards count alert title")
                              message:NSLocalizedString(@"卡牌数量必须是三张.", @"Cards count alert message")
                              delegate:nil
                              cancelButtonTitle:NSLocalizedString(@"确定", @"Button: OK")
